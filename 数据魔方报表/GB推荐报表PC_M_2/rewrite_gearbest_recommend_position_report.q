...
FROM
 (
    ...
    where get_json_object(x.sku,'$.mrlc') in ('S_1')
 ) m
group by
  m.platform,
  m.recommend_position
...
FROM
 (
    ...
    where get_json_object(x.sku,'$.mrlc') in ('S_2')
 ) m
group by
  m.platform,
  m.recommend_position
...
--所有结果汇总
INSERT OVERWRITE TABLE dw_proj.rewrite_gearbest_pc_recommend_position_report PARTITION (add_time = '${ADD_TIME}')
select
  NVL(a.pv,0),
  NVL(b.uv,0),
  c.exp_num,
  ...
  a.country
from  
(select pv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_pv_tmp where platform='pc' and recommend_position='mr_S_1' ) a 
left join 
(select uv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_uv_tmp where platform='pc' and recommend_position='mr_S_1' ) b
on a.add_time=b.add_time and  a.lang_code=b.lang_code and a.country=b.country
left join
(select exp_num,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_exp_num_tmp where platform='pc' and recommend_position='S_1' ) c
on a.add_time=c.add_time and  a.lang_code=c.lang_code and a.country=c.country
left join
(select sku_uv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_sku_uv_tmp where platform='pc' and recommend_position='S_1' ) d
on a.add_time=d.add_time and  a.lang_code=d.lang_code and a.country=d.country
left join
(select click_num,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_click_num_tmp where platform='pc' and recommend_position='S_1' ) e
on a.add_time=e.add_time and  a.lang_code=e.lang_code and a.country=e.country
left join
(select click_uv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_click_uv_tmp where platform='pc' and recommend_position='S_1' ) f
on a.add_time=f.add_time and  a.lang_code=f.lang_code and a.country=f.country
left join
(select cart_num,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_cart_num_tmp where platform='pc' and recommend_position='mr_S_1' ) g
on a.add_time=g.add_time and  a.lang_code=g.lang_code and a.country=g.country
left join
(select cart_uv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_cart_uv_tmp where platform='pc' and recommend_position='mr_S_1' ) h
on a.add_time=h.add_time and  a.lang_code=h.lang_code and a.country=h.country
left join
(select order_sku_num,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_order_sku_num_tmp where platform='pc' and recommend_position='mr_S_1' ) i
on a.add_time=i.add_time and  a.lang_code=i.lang_code and a.country=i.country
left join
(select order_uv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_order_uv_tmp where platform='pc' and recommend_position='mr_S_1' ) j
on a.add_time=j.add_time and  a.lang_code=j.lang_code and a.country=j.country
left join
(select gmv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_gmv_tmp where platform='pc' and recommend_position='mr_S_1' ) k
on a.add_time=k.add_time and  a.lang_code=k.lang_code and a.country=k.country
left join
(select purchase_num,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_purchase_num_tmp where platform='pc' and recommend_position='mr_S_1' ) l
on a.add_time=l.add_time and  a.lang_code=l.lang_code and a.country=l.country
left join
(select pay_uv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_pay_uv_tmp where platform='pc' and recommend_position='mr_S_1' ) m
on a.add_time=m.add_time and  a.lang_code=m.lang_code and a.country=m.country
left join
(select pay_amount,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_pay_amount_tmp where platform='pc' and recommend_position='mr_S_1' ) n
on a.add_time=n.add_time and  a.lang_code=n.lang_code and a.country=n.country
left join
(select collect_uv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_collect_uv_tmp where platform='pc' and recommend_position='mr_S_1' ) o
on a.add_time=o.add_time and  a.lang_code=o.lang_code and a.country=o.country
left join
(select collect_num,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_collect_num_tmp where platform='pc' and recommend_position='mr_S_1' ) p
...
select
  ...
  a.country
from  
(select pv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_pv_tmp where platform='pc' and recommend_position='mr_S_2' ) a 
left join 
(select uv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_uv_tmp where platform='pc' and recommend_position='mr_S_2' ) b
on a.add_time=b.add_time and  a.lang_code=b.lang_code and a.country=b.country
left join
(select exp_num,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_exp_num_tmp where platform='pc' and recommend_position='S_2' ) c
on a.add_time=c.add_time and  a.lang_code=c.lang_code and a.country=c.country
left join
(select sku_uv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_sku_uv_tmp where platform='pc' and recommend_position='S_2' ) d
on a.add_time=d.add_time and  a.lang_code=d.lang_code and a.country=d.country
left join
(select click_num,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_click_num_tmp where platform='pc' and recommend_position='S_2' ) e
on a.add_time=e.add_time and  a.lang_code=e.lang_code and a.country=e.country
left join
(select click_uv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_click_uv_tmp where platform='pc' and recommend_position='S_2' ) f
on a.add_time=f.add_time and  a.lang_code=f.lang_code and a.country=f.country
left join
(select cart_num,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_cart_num_tmp where platform='pc' and recommend_position='mr_S_2' ) g
on a.add_time=g.add_time and  a.lang_code=g.lang_code and a.country=g.country
left join
(select cart_uv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_cart_uv_tmp where platform='pc' and recommend_position='mr_S_2' ) h
on a.add_time=h.add_time and  a.lang_code=h.lang_code and a.country=h.country
left join
(select order_sku_num,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_order_sku_num_tmp where platform='pc' and recommend_position='mr_S_2' ) i
on a.add_time=i.add_time and  a.lang_code=i.lang_code and a.country=i.country
left join
(select order_uv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_order_uv_tmp where platform='pc' and recommend_position='mr_S_2' ) j
on a.add_time=j.add_time and  a.lang_code=j.lang_code and a.country=j.country
left join
(select gmv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_gmv_tmp where platform='pc' and recommend_position='mr_S_2' ) k
on a.add_time=k.add_time and  a.lang_code=k.lang_code and a.country=k.country
left join
(select purchase_num,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_purchase_num_tmp where platform='pc' and recommend_position='mr_S_2' ) l
on a.add_time=l.add_time and  a.lang_code=l.lang_code and a.country=l.country
left join
(select pay_uv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_pay_uv_tmp where platform='pc' and recommend_position='mr_S_2' ) m
on a.add_time=m.add_time and  a.lang_code=m.lang_code and a.country=m.country
left join
(select pay_amount,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_pay_amount_tmp where platform='pc' and recommend_position='mr_S_2' ) n
on a.add_time=n.add_time and  a.lang_code=n.lang_code and a.country=n.country
left join
(select collect_uv,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_collect_uv_tmp where platform='pc' and recommend_position='mr_S_2' ) o
on a.add_time=o.add_time and  a.lang_code=o.lang_code and a.country=o.country
left join
(select collect_num,add_time,lang_code,country from  dw_proj.rewrite_gearbest_pc_report_collect_num_tmp where platform='pc' and recommend_position='mr_S_2' ) p
on a.add_time=p.add_time and  a.lang_code=p.lang_code and a.country=p.country
;
