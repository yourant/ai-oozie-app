...
SET mapred.job.name=apl_result_rg_sku_remove_cate;
...
CREATE TABLE IF NOT EXISTS dw_rg_recommend.apl_result_rg_sku_remove_cate(
...
INSERT OVERWRITE TABLE dw_rg_recommend.apl_result_rg_sku_remove_cate
SELECT
	NVL(a.goods_sn1,'')              ,
	NVL(b.goodssn,'')              ,
	NVL(b.goodsid,0)              ,
...
FROM
	(
		SELECT
			...
			score
		FROM
			dw_rg_recommend.result_rg_sku_remove_cate
	) a
JOIN 
	dw_rg_recommend.apl_rg_goods_sn_2hbase_good_link b 
ON 
