...
SET mapred.job.name=apl_result_dl_sku_remove_cate;
...
CREATE TABLE IF NOT EXISTS dw_dresslily_recommend.apl_result_dl_sku_remove_cate(
...
INSERT OVERWRITE TABLE dw_dresslily_recommend.apl_result_dl_sku_remove_cate
SELECT
	NVL(a.goods_sn1,'')              ,
	NVL(b.goodssn,'')              ,
	NVL(b.goodsid,0)              ,
...
FROM
	(
		SELECT
			...
			score
		FROM
			dw_dresslily_recommend.result_dl_sku_remove_cate
	) a
JOIN 
