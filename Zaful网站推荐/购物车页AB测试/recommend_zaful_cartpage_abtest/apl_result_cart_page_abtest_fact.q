...
SET mapred.job.name='apl_result_cart_page_abtest_fact';
...
CREATE TABLE IF NOT EXISTS result_cart_page_abtest
(
...
CREATE TABLE IF NOT EXISTS apl_result_cart_page_abtest_fact(
...
INSERT OVERWRITE TABLE apl_result_cart_page_abtest_fact
SELECT
	goodsspu1,
	goods_sn2,
	goods_id,
...
SELECT
	...
	a.score
FROM
	apl_result_cart_page_abtest_fact a
LEFT JOIN
	apl_sku_lang_fact  b
ON
...
SELECT
	...
	NVL(score,0) score
FROM
	apl_result_cart_page_abtest_fact
ORDER BY
	score;