...
SET mapred.job.name='apl_result_cartpage_zaful_fact';
...
CREATE TABLE IF NOT EXISTS apl_result_cartpage_zaful_fact(
...
INSERT OVERWRITE TABLE  dw_zaful_recommend.apl_result_cartpage_zaful_fact
SELECT
	NVL(a.goods_spu1,'')              ,
	NVL(b.goodssn,'')              ,
	NVL(b.goodsid,0)              ,
...
FROM
	(
		SELECT
			...
			score
		FROM
			dw_zaful_recommend.result_cartdetail_lr
		WHERE
