...
CREATE TABLE IF NOT EXISTS result_detail_page_abtest_v3
(
...
CREATE TABLE IF NOT EXISTS apl_result_detail_page_abtest2_fact(
...
INSERT OVERWRITE TABLE apl_result_detail_page_abtest2_fact
SELECT
	goods_sn1,
	goods_sn2,
	goods_id,
...
SELECT
	...
	a.score
FROM
	apl_result_detail_page_abtest2_fact a
LEFT JOIN
	apl_sku_lang_fact  b
ON
...
SELECT
	...
	NVL(score,0) score
FROM
	apl_result_detail_page_abtest2_fact
ORDER BY
	score;
