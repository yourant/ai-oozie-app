...
SET mapred.job.name='apl_result_detailpage_zaful_abtest_v5';
...
CREATE TABLE IF NOT EXISTS result_detail_page_abtest_v5
(
...
CREATE TABLE IF NOT EXISTS apl_result_detailpage_zaful_abtest_v5(
...
INSERT OVERWRITE TABLE  dw_zaful_recommend.apl_result_detailpage_zaful_abtest_v5
SELECT
	NVL(a.goods_sn1,'')              ,
        NVL(a.platform,'')              ,
	NVL(b.goodssn,'')              ,
...
FROM
	(
		SELECT
			...
			score
		FROM
			dw_zaful_recommend.result_detail_page_abtest_v5
		WHERE
