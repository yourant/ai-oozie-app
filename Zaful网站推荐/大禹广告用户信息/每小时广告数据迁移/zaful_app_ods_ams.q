...
--  ;
 ...
 create table if not exists dw_zaful_recommend.zaful_app_abset_id_user_fb_all_every_hour(
...
insert OVERWRITE table dw_zaful_recommend.zaful_app_abset_id_user_fb_all_every_hour PARTITION (add_time='2019032103')
select 
b.adset_id,
...
--  )
--  and b.adset_id not in 
-- (select adset_id from dw_zaful_recommend.zaful_app_abset_id_user_fb_all_hour)
;


--  create table if not exists dw_zaful_recommend.zaful_app_abset_id_user_fb_all_hour(
--  adset_id                       STRING    comment 'fb广告id',
--  user_fb_all             STRING    comment '全部广告信息'
--  )
--  ROW FORMAT DELIMITED FIELDS TERMINATED BY '\u0001' LINES TERMINATED BY '\n' STORED AS TEXTFILE
...
-- insert OVERWRITE table dw_zaful_recommend.zaful_app_abset_id_user_fb_all_hour 
-- select 
-- b.adset_id,
-- concat('user_fb_age_range','=',b.user_fb_age_range,'||','user_fb_banner_click','=',b.user_fb_banner_click,'||','user_fb_platform','=',b.user_fb_platform,'||','user_fb_interests','=',b.user_fb_interests,'||','user_fb_genders','=',b.user_fb_genders)
-- from
