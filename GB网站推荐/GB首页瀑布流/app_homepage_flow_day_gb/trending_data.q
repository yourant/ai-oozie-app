...
CREATE TABLE IF NOT EXISTS result_gb_sale_cat_2week
(
	goods_sn         string  ,
	cat_id           string  ,
	score            double     ,
...
INSERT OVERWRITE TABLE result_gb_sale_cat_2week	
SELECT
	a.goods_sn,
	a.category_id,
	a.qty_1/qty_14,
...
SELECT
	...
	pipeline_code   
FROM
	result_gb_sale_cat_2week a
JOIN
	bf_good_sn b
ON
	a.goods_sn = b.bf_good_sn_value;
	

CREATE TABLE IF NOT EXISTS result_gb_cat_sku_500
(
	goods_spu         string  ,
	goods_sn          string,
	cat_id            string  ,
...
INSERT OVERWRITE TABLE result_gb_cat_sku_500
SELECT
	goods_spu,
	good_sn,
	id,
...
CREATE TABLE IF NOT EXISTS result_gb_cat_sku_app_mid
(
	goods_spu         string  ,
	goods_sn          string,
	cat_id            string  , 
...
INSERT OVERWRITE TABLE 	result_gb_cat_sku_app_mid
...
CREATE TABLE IF NOT EXISTS result_gb_cat_sku_app
(
	goods_spu         string  ,
	goods_sn          string,
	cat_id            int  , 
...
INSERT OVERWRITE TABLE result_gb_cat_sku_app
SELECT
	t1.goods_spu,
	goods_sn,
	t1.cat_id,
...
INSERT OVERWRITE TABLE gb_app_homepage_result 
SELECT
	t1.id tab_id,
	t3.good_sn,
	t3.pipeline_code,
...
CREATE TABLE IF NOT EXISTS gb_app_homepage_trending(
	tab_id             int        ,
...
INSERT OVERWRITE TABLE gb_app_homepage_trending
SELECT
	tab_id,
	good_sn,
	pipeline_code,
...
FROM(
	...
	FROM
		gb_app_homepage_trending
	)tmp;

INSERT OVERWRITE TABLE result_gb_cat_sku_app_popular
SELECT
	goods_sn        ,
	cat_id          ,
	score           ,
...
INSERT OVERWRITE TABLE gb_cat_sku_app_popular_result
SELECT
	000000,
	t3.good_sn,
	t3.pipeline_code,
...
CREATE TABLE IF NOT EXISTS gb_app_homepage_trending_rec(
	tab_id             int        ,
	good_sn            string     COMMENT '推荐商品SKU',
	pipeline_code      string     COMMENT '渠道编码',
	webGoodSn          string     COMMENT '商品webSku',
...
INSERT OVERWRITE TABLE gb_app_homepage_trending_rec
SELECT
	t1.tab_id      ,
	t1.good_sn         ,
	t1.pipeline_code   ,
...
FROM
	gb_app_homepage_trending_rec)t
WHERE
	flag = 1;
...
INSERT OVERWRITE TABLE gb_app_homepage_cat_name
SELECT
	tab_id,
	pipeline_code,
	catId,
...
INSERT OVERWRITE TABLE gb_app_homepage_brand_name
SELECT
	tab_id,
	pipeline_code,
	brandCode,
...
CREATE TABLE IF NOT EXISTS gb_app_homepage_trending_thirty(
	tab_id             int        ,
	good_sn            string     COMMENT '推荐商品SKU',
	pipeline_code      string     COMMENT '渠道编码',
	webGoodSn          string     COMMENT '商品webSku',
...
INSERT OVERWRITE TABLE gb_app_homepage_trending_thirty
SELECT
	tab_id,
	good_sn,
	pipeline_code,
...
SELECT
	...
	score
FROM
	gb_app_homepage_trending_thirty
UNION ALL
SELECT
	tab_id      ,
	good_sn         ,
...
CREATE TABLE IF NOT EXISTS gb_app_homepage_trending_thirty_rec(
	tab_id             int        ,
	good_sn            string     COMMENT '推荐商品SKU',
	pipeline_code      string     COMMENT '渠道编码',
	webGoodSn          string     COMMENT '商品webSku',
...
INSERT OVERWRITE TABLE gb_app_homepage_trending_thirty_rec
SELECT
	t1.tab_id      ,
	t1.good_sn         ,
	t1.pipeline_code   ,
...
FROM
	gb_app_homepage_trending_rec t1
JOIN
	goods_info_mid5 t2
ON
